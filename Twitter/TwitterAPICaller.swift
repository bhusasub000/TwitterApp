...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "ckU2jmSIsjMzjEjXbPxvIRhaW", consumerSecret: "LQCkISiDMlGHTjuz7XvvRVHgep0MvvobpT3ModEy7vp309KUKY")
    var loginSuccess: (() -> ())?
